  ...
  return (
    <>
      <div className="relative py-16 px-3 text-off-white bg-bgcolor flex justify-center items-center">
        ...
        <div className="relative bg-bgcolor bg-opacity-60 border-2 border-off-white p-6 rounded-xl backdrop-blur-md w-full sm:w-96 md:p-10">
          ...
          <form onSubmit={handleLogin} className="grid gap-7">
            <div className="relative grid grid-cols-1 gap-2 border-b-2 border-off-white">
            ...
            <div className="flex justify-between items-center text-sm mb-6">
              <div className="flex items-center">
                <input type="checkbox" className="w-3 h-3 text-off-white border-off-white" id="login-check" />
            ...
            <button
              type="submit"
              className="w-full p-4 text-black bg-charcoal rounded-lg font-medium hover:bg-gray-300 transition duration-300"
            >
              Login
            </button>
